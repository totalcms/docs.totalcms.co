...
$out[] = '- 33 reserved collection schemas plus unlimited custom schemas';
$out[] = '- Twig templating with 89 custom filters and 49 custom functions';
...
$out[] = '- Automations — schedule, webhook, and event-triggered handlers with a job queue and run history';
$out[] = '- Built-in MCP server (Pro) — exposes collections, schemas, and search to AI agents over OAuth 2.1';
$out[] = '- Installs with Composer: `composer create-project totalcms/totalcms`';
$out[] = '';
$out[] = '## Documentation';
